...
var TROWEL_ICON = '.icon-trowel-outline';
...
function fixBanner() {
    ...
    var bigScreen = window.innerWidth >= 1060;
    offset = $('header').height() - $(window).scrollTop();
...
function shrinkNav() {
    $(MAIN_NAV).add(BANNER).add(LOGO_WRAP).addClass('shrink');
}
// Fully expands banner, nav, & logo
function expandNav() {
    $(MAIN_NAV).add(BANNER).add(LOGO_WRAP).removeClass('shrink');
}
...
function callToActionHeightFix() {
    ...
    $('.overview .lg-img').each(function (i, el) {
...
function burgerClick() {
    $('.burger-btn').on('click', function (e) {
        e.preventDefault();
        var burger = '.burger-btn, .burger-icon, ' + MAIN_NAV;
...
function burgerHover() {
    // NOT FINISHED
    var deg = 90;
    $('.burger-btn').on('mouseenter', function (e) {
        e.preventDefault();
...
function trowelClick() {
    $(TROWEL_ICON).on('click', function (e) {
        e.preventDefault();
...
//     e.preventDefault();
// });
}).call(this,require("FT5ORs"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_1e187d15.js","/")
},{"FT5ORs":4,"buffer":2}]},{},[5])