...
function fixBanner() {
    ...
    if (offset <= 125) {
        if (offset <= 0) {
            ...
            $('.main-nav').add('.banner').add('.logo-wrap').addClass('shrink');
        } else {
        ...
        $('.main-nav').add('.banner').add('.logo-wrap').removeClass('shrink');
    }
}
...
}).call(this,require("FT5ORs"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_29c2a265.js","/")
},{"FT5ORs":4,"buffer":2}]},{},[5])