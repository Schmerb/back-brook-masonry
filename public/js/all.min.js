...
function checkScrollPos() {
    $(window).scroll(function (e) {
        ...
        // leaves the window
        var offset = $('header').height() - $(window).scrollTop();
        if (offset <= 125) {
            // fix banner
            ...
            if (offset < 0) {
                ...
                $('.banner').add('.main-nav').add('.logo-wrap').addClass('shrink');
            } else {
                $('header').css('z-index', '');
                $('.banner').add('.main-nav').add('.logo-wrap').removeClass('shrink');
            }
        } else {
            $('header').css('z-index', '');
            $('.banner').add('.main-nav').add('.logo-wrap').removeClass('fixed').removeClass('shrink');
        }
    });
}
...
function burgerClick() {
    $('.burger-btn').on('click', function (e) {
        e.preventDefault();
        $('.burger-icon').add('.main-nav').toggleClass('open');
    });
}
...
}).call(this,require("FT5ORs"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_805ac0a8.js","/")
},{"FT5ORs":4,"buffer":2}]},{},[5])